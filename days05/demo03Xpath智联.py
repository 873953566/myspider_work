...
#
url = 'https://sou.zhaopin.com/jobs/searchresult.ashx?jl=%E9%83%91%E5%B7%9E%2B%E4%B8%8A%E6%B5%B7%2B%E5%8C%97%E4%BA%AC%2B%E5%B9%BF%E5%B7%9E&kw=python&p=1&isadv=0'
...
for jobname in job_names:
    f.write(jobname.xpath("string(.)").strip().encode("utf-8") + "\r\n")
f.close()
# headers = {
#     "User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.7 Safari/537.36",
# }
